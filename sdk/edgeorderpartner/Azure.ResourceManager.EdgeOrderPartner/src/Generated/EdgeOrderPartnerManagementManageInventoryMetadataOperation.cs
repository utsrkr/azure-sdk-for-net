...
namespace Azure.ResourceManager.EdgeOrderPartner
{
    ...
    public partial class EdgeOrderPartnerManagementManageInventoryMetadataOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of EdgeOrderPartnerManagementManageInventoryMetadataOperation for mocking. </summary>
        protected EdgeOrderPartnerManagementManageInventoryMetadataOperation()
        {
        }

        internal EdgeOrderPartnerManagementManageInventoryMetadataOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "EdgeOrderPartnerManagementManageInventoryMetadataOperation");
        }
        /// <inheritdoc />
