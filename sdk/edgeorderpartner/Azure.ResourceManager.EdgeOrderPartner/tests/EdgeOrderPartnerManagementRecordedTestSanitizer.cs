...
{
    public class EdgeOrderPartnerManagementRecordedTestSanitizer : RecordedTestSanitizer
    {
        public string SubscriptionId { get; set; }

        public EdgeOrderPartnerManagementRecordedTestSanitizer() : base()
        {
        ...
        public override void Sanitize(RecordSession session)
        {
            ...
            if (session.Variables.ContainsKey(EdgeOrderPartnerManagementTestEnvironment.SubscriptionIdEnvironmentVariableName))
            {
                SubscriptionId = session.Variables[EdgeOrderPartnerManagementTestEnvironment.SubscriptionIdEnvironmentVariableName];
            }
